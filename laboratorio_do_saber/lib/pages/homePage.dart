...
class _HomePageState extends State<HomePage> {
  ...
  // Páginas para cada aba da bottom navigation
...
// Conteúdo da página inicial (seu código original melhorado)
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Header de boas-vindas conectado à AppBar
          Container(
